...
def group_by_centroid(restaurants, centroids):
    ...
    """
    # BEGIN Question 4
    return group_by_first([[find_closest(restaurant_location(res), centroids),
...
def rate_all(user, restaurants, feature_fns):
    ...
    reviewed = user_reviewed_restaurants(user, restaurants)
    # BEGIN Question 9
    return {restaurant_name(res): predictor(res) if not res in reviewed else user_rating(user, restaurant_name(res)) for res in restaurants}
    # END Question 9
